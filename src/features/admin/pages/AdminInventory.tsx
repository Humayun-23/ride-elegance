...
import { getAdminShops, getAdminShopBikes, updateAdminBike, uploadAdminBikeImages, createAdminBike, deleteAdminBike } from "@/features/admin/services/adminService";
